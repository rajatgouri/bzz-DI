...
const endpoints = methods.crudController("WQEDCOMCCheckmark");
const Util = require('./utilController')

var sql = require("mssql");

const Model = "WQEDCOMCCheckmark";
const calendarModal = "CalendarStaff";
const progressModel = 'WQEDCOMCProgress'
const wqModal = 'WQEDCOMC'
const userModal = "JWT";
