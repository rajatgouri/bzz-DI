...

          {
            modalType == "EDIT" || modalType == "ADD" ?
              <Form
                ...
                form={editForm}
              >
                <label className="mb-5 mt-5 d-block">Departmant: </label>
                <Form.Item
                  label=""
                  name="Dept"
                  class="mb-5 mt-5"
                ...
                >
                  <Select>
                    {
                      filters['Dept'] && filters['Dept'].map(d => {
                ...
                <label className="mb-5 mt-5 d-block">Due Date: </label>
                ...
                <label className="mb-5 mt-5 d-block"> Priority: </label>
                ...
                <label className="mb-5 mt-5 d-block">Request Name: </label>
                ...
                <label className="mb-5 mt-5 d-block">Business Case: </label>
                ...
                <label className="mb-5 mt-5 d-block">Pain Point: </label>
...

                  {
                    ...
                    <label className="mb-5 mt-5 d-block">Assignee: </label>
