...
import MCExportLoggersDataTableModule from "@/modules/MCExportLoggersDataTableModule";


export default function WQEDCOMCExport() {
  ...
  const entity = "WQEDCOMCExportLogger";
 ...
 const getFilters = async () => {
  ...
  const panelTitle = "";
  const dataTableTitle = "WQEDCOMC Export";
  ...
  {
  return  <MCExportLoggersDataTableModule config={config} />
  }  
}
