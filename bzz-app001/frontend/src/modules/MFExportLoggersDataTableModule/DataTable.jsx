...
import { mfExport as  crud } from "@/redux/mf-export/actions";


import { selectAuth } from "@/redux/auth/selectors";
import { selectMfExportsList } from "@/redux/mf-export/selectors";

export default function DataTable({ config }) {

  const [previousEntity, setPreviousEntity] = useState('');
  let { entity, dataTableColumns, dataTableTitle, reload, getFilterValue, showProcessFilters, userList, onRowMarked } = config;
  ...
  var { result: listResult, isLoading: listIsLoading } = useSelector(selectMfExportsList);
